...
func TestPrintUsage(t *testing.T) {
	...
	if !strings.Contains(stdout, "postgram vtest-version") {
...
func TestCmdSaveAndSearch(t *testing.T) {
	...
	withArgs(t,
		"postgram", "save", "my-title", "my-content",
		"--type", "bugfix",
		"--project", "alpha",
		"--scope", "personal",
		"--topic", "auth/token",
	...
	withArgs(t, "postgram", "search", "my-content", "--type", "bugfix", "--project", "alpha", "--scope", "personal", "--limit", "1")
	...
	withArgs(t, "postgram", "search", "definitely-not-found")
...
func TestCmdTimeline(t *testing.T) {
	...
	withArgs(t, "postgram", "timeline", focusID, "--before", "1", "--after", "1")
...
func TestCmdContextAndStats(t *testing.T) {
	...
	withArgs(t, "postgram", "context", "project-x")
	...
	if !strings.Contains(statsOut, "Postgram Memory Stats") || !strings.Contains(statsOut, "project-x") {
...
func TestCmdExportAndImport(t *testing.T) {
	...
	withArgs(t, "postgram", "export", exportPath)
	...
	withArgs(t, "postgram", "import", exportPath)
...
func TestMainVersionAndHelpAliases(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "version", arg: "version", contains: "postgram 9.9.9-test", notStderr: true},
		{name: "version short", arg: "-v", contains: "postgram 9.9.9-test", notStderr: true},
		{name: "version long", arg: "--version", contains: "postgram 9.9.9-test", notStderr: true},
...
func TestMainExitHelper(t *testing.T) {
	...
	case "no-args":
		os.Args = []string{"postgram"}
	case "unknown":
		os.Args = []string{"postgram", "definitely-unknown-command"}
	default:
		os.Args = []string{"postgram", "--help"}
	}
...
func TestCmdSearchLocalMode(t *testing.T) {
	...
	withArgs(t, "postgram", "search", "local", "--project", "proj-local")
